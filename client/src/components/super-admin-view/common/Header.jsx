...
import { useAuth } from "@/context/auth-context"; // Ajout pour récupérer l'utilisateur
...
function Header() {
  const { auth, resetCredentials } = useAuth(); // 🛠 on utilise le hook pour récupérer user
