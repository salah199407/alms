    ...
    <div className="flex min-h-screen flex-col">
              ...
              <Tabs defaultValue="contenu" className="w-full mt-8">
                ...
                <TabsContent value="contenu" className="mt-8 space-y-10">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="prose max-w-none text-base">
                      <p>{course.description || course.welcomeMessage || "No description available."}</p>
                      {course.objectives && <p>{course.objectives}</p>}
                      <p>
                        This course is designed for professionals who want to deepen their knowledge and skills in this field. You will learn through concrete examples and practical exercises.
                      </p>
                      <p>
                ...
                <TabsContent value="certif" className="mt-8 space-y-8">
                  <div className="bg-white border-2 rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-8">
                      <div className="border-2 rounded-xl p-8 mb-8 bg-gray-50">
                        <div className="text-center mb-8">
                          <div className="text-base text-muted-foreground uppercase tracking-wider mb-2">
                        ...
                        <div className="flex justify-between items-center mb-6">
                          <div className="text-base">
                            ...
                            <div className="text-muted-foreground">First Last</div>
                          </div>
                          <div className="text-base text-right">
                            <div className="font-medium">Issue Date</div>
                            <div className="text-muted-foreground">MM/DD/YYYY</div>
                          </div>
                        </div>

                        <div className="flex justify-center mt-6">
                          <div className="h-16 w-40 bg-[#ff7900]/20 rounded-lg flex items-center justify-center text-[#ff7900] font-medium">
                            Signature
                          </div>
                        </div>
                      </div>
                ...
                <TabsContent value="instructeur" className="mt-8 space-y-8">
                  ...
                  <div className="bg-white p-8 rounded-xl border-2 shadow-md">
                    <h3 className="text-xl font-bold mb-6">Other Trainings by This Instructor</h3>
      ...
      <footer className="w-full border-t py-8 bg-gray-50">
        <div className="container mx-auto px-6 flex flex-col items-center justify-between gap-6 md:flex-row">
          <p className="text-base text-muted-foreground">© 2025 Orange Learning. All rights reserved.</p>
          <div className="flex gap-6">
            <Link
              href="#"
              className="text-base text-muted-foreground hover:text-[#ff7900] hover:underline transition-colors"
            >
              Terms of Use
            </Link>
            <Link
  ...
  if (!curriculum || curriculum.length === 0) {
    return [
      ...
      },
      {
        title: "Deepening",
        duration: "10 hours",
        topics: ["Advanced Concepts", "Practical Case Studies", "Specialized Techniques", "Guided Projects"],
      },
      {
...
function getDefaultReviews() {
  return [
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "I highly recommend this training to everyone who wants to perfect their skills in this field. The instructor is very competent and the provided resources are of high quality.",
    },
  ]
}
...
function getMockCourseData(id) {
  ...
  return {
    ...
    subtitle: "Master the modern frameworks and best practices of web development",
    description:
    ...
    prerequisites: [
      ...
      "Understanding of Base API Concepts",
    ],
    learningOutcomes: [
      "Master Modern JavaScript Frameworks (React, Vue, Angular)",
      "Design Evolving and Maintainable Front-End Architectures",
    ...
    targetAudience: [
      "Web Developers Seeking to Deepen Their Skills",
      ...
      "Entrepreneurs Seeking Technical Skills for Their Projects",
    ],
